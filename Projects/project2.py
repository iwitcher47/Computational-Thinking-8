...
print("d) you would make a joke about monkeys, ")
print("e) you would say monkeys freak me out, ")
print("f) what were we talking about?")
q1 = input("")
if q1 == "f":
    joey += 1
elif q1 == "d":
...
print("e) oh... i wish it was one of those hairless cats. i love those. ")
print("f) THIS IS WHAT I WAS GETTING?? I DONT WANT THIS")
...
print("a) you would say a weird fact about a hobby you have, ")
print("b) you would just sit there and blink at them, ")
print("c) you told the story, ")
print("d) you would make a joke about something that was in the story, ")
print("e) you would get up and walk away, ")
print("f) you would say, that reminds me about a story i have about fish.")
...
print("a) you would get a job about something you really like that is kinda weird, ")
print("b) you would be a chef ")
print("c) you dont really have a job, ")
print("d) you have a boring office job, ")
print("e) something in fashion, ")
print("f) actor.")
